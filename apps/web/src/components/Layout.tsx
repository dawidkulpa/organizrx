...
import { cn } from '../utils'; // I'll need a utils file for clsx/tailwind-merge
import { 
  LayoutDashboard, 
  Settings, 
  Users, 
...
export default function Layout() {
  ...
  const navItems = [
    ...
    { name: 'Wizard', path: '/wizard', icon: Zap },
    ...
    <div className="flex h-screen bg-background overflow-hidden">
      ...
      <aside 
        className={cn(
          ...
          isMobile && !sidebarOpen && "-ml-16", // Hide completely on mobile if closed
      ...
      >
        <div className="h-16 flex items-center justify-between px-4 border-b border-border">
          {sidebarOpen ? (
            ...
            <div className="mx-auto font-bold text-xl text-primary">A</div>
          )}
